...
/**
 * Data source for the Reservations view. This class should
...
export class ReservationsDataSource extends DataSource<ReservationsItem> {
   ...
   */
  private getPagedData(data: ReservationsItem[]): ReservationsItem[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: ReservationsItem[]): ReservationsItem[] {
